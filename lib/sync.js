...
// ═══════════════════════════════════════════════════════════════════════════
import { canonicalJSON, mergeStates, sharedSlice } from './store';
...
// Key-order independent: Postgres jsonb reorders object keys on the way back.
const sig = (doc) => canonicalJSON(sharedSlice(doc || {}));
