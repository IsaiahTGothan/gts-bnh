// ═══════════════════════════════════════════════════════════════════════════
//  GTS HUB — MANAGER PIN HASHING (browser)
//  SHA-256 via WebCrypto with a pure-JS fallback (older kiosks / non-secure
//  contexts). The hash lives in the shared management doc; the PIN never does.
// ═══════════════════════════════════════════════════════════════════════════
const SALT = 'gts-hub-manager-pin:';
